  ...
  return (
    <div className="flex justify-center xs:flex-col gap-10 mb-28 ">
      ...
      <div className="flex flex-col  items-center gap-5">
        <div className=" items-center  relative h-20 w-20 rounded-full bg-gray-200">
          <div className=" absolute bottom-3 left-3 h-14 w-14  rounded-full bg-gray-950">
            <svg
              ...
              className=" absolute bottom-2 left-2 "
            >
              <g clip-path="url(#clip0_2038_352)">
                <path
        ...
        <div className="mb-3">
          <h2 className=" text-xl font-semibold">24/7 CUSTOMER SERVIC</h2>
          <p className="text-sm font-normal">Friendly 24/7 customer suppor</p>
        </div>
      </div>
      <div className="flex flex-col  items-center gap-5">
